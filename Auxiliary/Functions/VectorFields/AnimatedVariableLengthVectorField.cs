...
namespace Thecentury.Functions.VectorFields {
	public class AnimatedVariableLengthVectorField : GAnimatedVectorField {
		/// <summary>
		/// 
		/// </summary>
		/// <param name="f">xyt->al - Угол a измеряется в радианах, l - длина вектора в пикселах</param>
		public AnimatedVariableLengthVectorField(formula f) {
			this.f = f;
		}
